...
class Developer:
    def __init__(self):
        self.name = "NotKiwy & Chadwy"
        self.role = "Full-Stack Developer"
        self.languages = ["Python", "JavaScript", "TypeScript", "C++", "C#", "HTML/CSS"]
        self.backend = ["Flask", "Node.js", ".NET"]
        self.database = ["PostgreSQL", "SQLite"]
        self.tools = ["Git", "Docker", "Figma""]
        self.design = ["UI/UX Design", "Prototyping"]
...
- 💬 *Telegram:* [Chadwy](https://t.me/chadwy)

---

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=NotKiwy&color=blueviolet&style=flat" alt="Profile views" />
  <a href="https://github.com/NotKiwy?tab=followers">
    <img src="https://img.shields.io/github/followers/NotKiwy?label=Follow&style=social" alt="Followers">
  </a>
</p>
